...
const doc = new Document({
    ...
    sections: [{
        ...
        children: [
            ...
            bullet('Leaderboard XP de la gameweek + podium top 3 lundi'),
            ...
            new Table({
                ...
                rows: [
                    ...
                    tableRow(['Podium + défis', 'Lundi 00:05', 'Récompense top 3 XP de la GW précédente + génération des 3 défis de la nouvelle semaine.']),
            ...
            new Table({
                ...
                rows: [
                    ...
                    tableRow(['Streak 14 jours', '+200 XP + carte rare']),
                    tableRow(['Streak 30 jours', '+500 XP + carte epic']),
                    ...
                    tableRow(['Podium #1 / #2 / #3', '+150 epic / +100 rare / +50 common']),
                    tableRow(['Level-up', 'Carte pending (tier selon niveau : common <5, rare ≥5, epic ≥10)']),
                ],
            }),
            ...
            bullet('Lundi 00:05 : settle podium top 3 de la GW précédente + annonce Discord branded'),
            bullet('Anti-doublon podium par utilisateur / semaine'),

            heading('3.5 Coffre de cartes (claim V1)', HeadingLevel.HEADING_2),
            bullet('Cartes pending : quête, level-up, streak, podium, quiz win'),
            ...
            para('Compétition → leaderboard GW + podium lundi'),
